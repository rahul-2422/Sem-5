...
const sql = `CREATE TABLE IF NOT EXISTS dummytable(gender VARCHAR(20),name varchar(255),id varchar(255),weight varchar(255),bmi varchar(255));`;
...
app.post("/submit", (req, res) => {
    ...
    const query = "insert into dummytable values (?,?,?,?,?);";
    const result = [gender, name, id, weight, bmi];
